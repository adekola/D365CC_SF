      ...
      initialize() {
        if (void 0 === window.sforce || void 0 === window.sforce.opencti) {
          const o = "/support/api/54.0/lightning/opencti.js",
            t = `${new URL(document.referrer).origin}${o}`;
          return e.loadScript(t);
        }
      ...
      bindEvents() {
        ...
        const t =
          null ===
            ...
            : o.EmbedSDK;
        t &&
          (t.conversation.onConversationLoaded((e) => {
            console.log("Conversation loaded:", e),
              console.log("Available properties:", Object.keys(e)),
              console.log("customerPhoneNumber:", e.customerPhoneNumber),
              console.log("customerName:", e.customerName);
            const { liveWorkItemId: o, customerPhoneNumber: t } = e;
            console.log(e),
              (this.conversationStartTimes[o] = new Date()),
              (this.callerNumbers[o] = t || ""),
              console.log("Stored phone number:", this.callerNumbers[o]);
          }),
          t.conversation.onStatusChange((e) => {
            const { liveWorkItemId: o, statusCode: t } = e;
            if (
              (console.log("Status update received:", e),
              console.log(`Status code for liveWorkItemId ${o}:`, t),
              5 === t || 4 === t)
            ) {
              const e = this.conversationStartTimes[o],
                ...
                n = {
                  ...
                  callType: "Inbound",
                  Call_Duration__c: Math.floor(
                    (t.getTime() - e.getTime()) / 1e3
                  ),
                  ContactPhone: this.callerNumbers[o],
                  entityApiName: "Case",
                  CaseNumber: "",
                };
              console.log("Log data to be saved:", n),
